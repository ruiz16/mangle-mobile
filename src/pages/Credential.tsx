      ...
      {isLoading ? (
        ...
        <>
          ...
          style={{
            ...
            boxShadow: '0 24px 64px rgba(176,91,53,0.35), 0 4px 16px rgba(0,0,0,0.6)',
        ...
        >
          ...
          <div className="relative p-5 flex flex-col gap-5">
            ...
            <div className="flex justify-between items-start">
              <div>
                <p className="text-[7px] uppercase tracking-[0.25em] text-orange-200/60 font-semibold">Garantía Social</p>
                <p className="text-sm font-black tracking-wide font-display">MANGLE VC</p>
              </div>
              <div className="w-8 h-8 rounded-full bg-black/20 flex items-center justify-center border border-white/15 backdrop-blur-sm">
                {/* icono wallet */}
                <i className="text-sm font-bold text-white fa fa-wallet"></i>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 relative z-10">
              <div className="relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <span className="text-[7px] text-orange-200/70 uppercase tracking-widest mt-0.5">puntos</span>
                </div>
              </div>
              <span
            ...
            <div className="flex justify-between items-end pt-1 border-t border-white/10">
              <div>
                <p className="text-[7px] text-orange-200/50 uppercase tracking-wider">Titular</p>
